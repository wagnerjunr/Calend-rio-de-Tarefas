...
const DailyTask = ({ taskName, tasks }: boxDayProps) => {
  ...
  return (
    <div className="daily-container">
      <h2 className={taskName === 'Hoje' ? 'box-day' : 'box-daily'}>
        {taskName}
      </h2>
            ...
            <div key={task.id}>
              <div className="box-input">
                <section
                  className={
                    task.priority === 'Baixa'
                      ? 'box-infos low-priority'
                      : task.priority === 'Média'
                      ? 'box-infos medium-priority'
                      : task.priority === 'Alta'
                      ? 'box-infos high-priority'
                      : ''
                  }
                >
                  <input
                  ...
                  />
                  <label
                    className={checkBoxStates[task.id] ? 'completed-task' : ''}
